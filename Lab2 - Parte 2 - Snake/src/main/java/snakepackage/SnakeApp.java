...
//        new Cell(1, (GridSize.GRID_HEIGHT / 2) / 2)};
    ...
    public SnakeApp() {
        ...
        lbl_serpienteMasLarga = new JLabel("Serpiente más larga:");
    ...
    /**
     * Metodo encargado de dar la acción a los botones.
     */
    ...
    public void accionBotonPausar(){
        ...
        if(serpientePeor==-1){
            ...
            lbl_serpientePeor.setText("La serpiente que se murió de primeras tiene el id: "+serpientePeor+".");
        }
        ...
        if(serpienteMasLarga==-1){
            ...
            lbl_serpienteMasLarga.setText("La serpiente viva más larga tiene el id: "+serpienteMasLarga+".");
        }
...
//            System.out.println("snakepackage.SnakeApp.traerLaSerpientePeor()");
    ...
    /**
     * Metodo encargado de traer la serpiente viva más larga
